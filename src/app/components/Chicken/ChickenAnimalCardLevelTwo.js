...
class ChickenAnimalCard extends Component {
  constructor() {
    super();
    this.state = {
      animalName: "",
  ...
  generateQuestionsForm = () => {
    ...
    let swimArray = [(<option key="1">polygam</option>), (<option key="2">monogam</option>), (<option key="3">mono-polygam</option>)]; 
    ...
    let headerArray = ["Hühnerart", "Paarbildung", "Brutort", "Anzahl Eier?"];
...
export default connect(mapStateToProps)(ChickenAnimalCard);