...
class ChickenGameInfo extends Component {
  constructor(props) {
    super();
    this.state = {
      modalVisible: false,
  ...
  handleOnChange = (event) => {
    ...
    console.log("ChickenGame Level changed!" + " " + value);
...
//    });
    ...
    console.log("ChickenGame Level end!");
  }
...
export default connect(mapStateToProps)(ChickenGameInfo);
