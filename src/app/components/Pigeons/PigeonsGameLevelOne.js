...
import PigeonsAnimalCard from "./PigeonsAnimalCard";
...
class PigeonsGameLevelOne extends Component {
  constructor(props) {
    super();
      ...
      if (this.props.progress === this.props.totalQuestions && !this.props.showTheOverlay) {
        ...
        ducksCard = (
          (!this.props.showTheOverlay) ?
            <PigeonsAnimalCard item={this.state.thePigeons[this.state.currentItem]} 
                             solutionHandler={this.checkSolution} 
                             inputData={this.state.allNames} 
                             myCardTitle="Taubenart" 
...
export default connect(mapStateToProps)(PigeonsGameLevelOne);