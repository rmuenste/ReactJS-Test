...
class PigeonsGameInfo extends Component {
  constructor(props) {
    super();
    this.state = {
      modalVisible: false,
  ...
  handleOnChange = (event) => {
    ...
    console.log("PigeonsGame Level changed!" + " " + value);
...
//    });
    ...
    console.log("PigeonsGame Level end!");
  }
...
export default connect(mapStateToProps)(PigeonsGameInfo);
