...
class SeedsGameInfo extends Component {
  constructor(props) {
    super();
    this.state = {
      modalVisible: false,
  ...
  handleOnChange = (event) => {
    ...
    console.log("SeedsGame Level changed!" + " " + value);
...
//    });
    ...
    console.log("SeedsGame Level end!");
  }
...
export default connect(mapStateToProps)(SeedsGameInfo);
