...
class RavensGameInfo extends Component {
  constructor(props) {
    super();
    this.state = {
      modalVisible: false,
  ...
  handleOnChange = (event) => {
    ...
    console.log("RavensGame Level changed!" + " " + value);
...
//    });
    ...
    console.log("RavensGame Level end!");
  }
...
export default connect(mapStateToProps)(RavensGameInfo);
