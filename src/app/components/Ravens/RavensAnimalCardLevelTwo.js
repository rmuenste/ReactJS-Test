...
class RavensAnimalCard extends Component {
  constructor() {
    super();
    this.state = {
      animalName: "",
  ...
  generateQuestionsForm = () => {
    ...
    let breedingArray = [
                          ...
                          (<option key="2">Baum-Felsbrüter</option>),
                          (<option key="3">Felsbrüter</option>),
                          (<option key="4">Höhlenbrüter</option>),
                          (<option key="5">Baum-Heckenbrüter</option>),
                          (<option key="6">Baumbrüter</option>)
                        ]; 
    ...
    let headerArray = ["Rabenart", "Ablegetyp", "Brutort", "Anzahl Eier?"];

    let solutionArray = [this.props.item.name, this.props.item.children, this.props.item.breeding, this.props.item.eggs];
...
export default connect(mapStateToProps)(RavensAnimalCard);