...
import RavensAnimalCard from "./RavensAnimalCard";
...
class RavensGameLevelOne extends Component {
  constructor(props) {
    super();
      ...
      if (this.props.progress === this.props.totalQuestions && !this.props.showTheOverlay) {
        ...
        ducksCard = (
          (!this.props.showTheOverlay) ?
            <RavensAnimalCard item={this.state.theRavens[this.state.currentItem]} 
                             solutionHandler={this.checkSolution} 
                             inputData={this.state.allNames} 
                             myCardTitle="Rabenart" 
...
export default connect(mapStateToProps)(RavensGameLevelOne);