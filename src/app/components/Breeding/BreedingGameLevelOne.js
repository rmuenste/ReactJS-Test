      ...
      if (this.props.progress === this.props.totalQuestions && !this.props.showTheOverlay) {
        ...
        ducksCard = (
          (!this.props.showTheOverlay) ?
            <BreedingAnimalCard item={this.state.theBreeding[this.state.currentItem]} 
...
export default connect(mapStateToProps)(BreedingGameLevelOne);