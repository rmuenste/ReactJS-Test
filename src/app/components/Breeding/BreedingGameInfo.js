...
class BreedingGameInfo extends Component {
  constructor(props) {
    super();
    this.state = {
      modalVisible: false,
  ...
  handleOnChange = (event) => {
    ...
    console.log("BreedingGame Level changed!" + " " + value);
...
//    });
    ...
    console.log("BreedingGame Level end!");
  }
...
export default connect(mapStateToProps)(BreedingGameInfo);
